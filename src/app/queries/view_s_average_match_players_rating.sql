...
SELECT "HomeTeam", "AwayTeam", "Date", "AveragePlayersRating"
FROM average_match_players_rating
WHERE "AveragePlayersRating" >= {rating}
ORDER BY "AveragePlayersRating" DESC